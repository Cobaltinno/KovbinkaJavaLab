...
public class StreamTest {
    ...
    public static void main(String[] args) {
        ...
        EmpServiceStream zmagServiceStream = new EmpServiceStream(employes);

        System.out.println("Sorted by name:");
        EmpServiceStream.sortEmployeeByName().forEach(employee -> System.out.println(employee.getName()));

        System.out.println("\nSorted by date of birth:");
        EmpServiceStream.sortEmployeeByName().forEach(employee -> System.out.println(employee.getName()));

        System.out.println("\nFiltered by part of the name:");
        EmpServiceStream.getByPartName("Iv").forEach(employee -> System.out.println(employee.getName()));
    }
}